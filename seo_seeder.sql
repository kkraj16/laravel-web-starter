-- Standalone SEO Seeder SQL
-- --------------------------------------------------------

-- 1. Create the seo_metas table first if not exists
...
-- 2. Populate Page-wise SEO
-- HOME PAGE
DELETE FROM `seo_metas` WHERE `route_name` = 'home';
INSERT INTO `seo_metas` (`route_name`, `page_path`, `meta_title`, `meta_description`, `meta_keywords`, `canonical_url`, `og_title`, `og_description`, `og_image`, `robots`, `created_at`, `updated_at`)
VALUES 
