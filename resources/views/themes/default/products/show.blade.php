        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div class="flex flex-col">
                ...
                <div class="mt-auto space-y-3">
                     ...
                     @else
                         @if($product->price == 0)
                            <a href="https://wa.me/919876543210?text=Enquiry for {{ $product->name }} ({{ url()->current() }})" target="_blank" class="flex items-center justify-center gap-2 w-full py-4 bg-[#25D366] text-white text-xs font-bold uppercase tracking-[0.2em] hover:bg-[#128C7E] transition-colors rounded-sm shadow-md">
                                ...
                                Request Price / Enquiry
                            </a>
                        @else
                            <button class="w-full py-4 bg-neutral-900 text-white text-xs font-bold uppercase tracking-[0.2em] hover:bg-black transition-colors rounded-sm shadow-xl">
                                Add to Quote
                            </button>
                        @endif
                     @endif
