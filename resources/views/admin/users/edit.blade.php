        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title fw-bold">Edit User: {{ $user->name }}</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label text-uppercase fs-7 fw-bold text-muted">New Password <small>(Leave blank to keep current)</small></label>
                            <input type="password" name="password" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-uppercase fs-7 fw-bold text-muted">Confirm New Password</label>
                ...
                <div class="card-footer text-end">
                    ...
                    <button type="submit" class="btn btn-info text-white px-4">Update User</button>
                </div>
            </div>
        </form>
    </div>
